...
<body>
    ...
    <div id="main-content-wrapper">
        ...
        <div class="container-fluid pt-3 pb-1 px-3 epilogue">
            <h1 class="titles">Double-Check your Articles</h1>
        </div>
        ...
        <div class="container-fluid p-3 poppins-regular">
                    ...
                    <div class="card-title">
                        <div class="row row-cols-1 row-cols-md-2 g-3">
                            ...
                            <div class="col-md-2 col-12 justify-content-end d-flex">
                                <a class="btn w-auto  buttonBrand" href="../user/user_add_new_article_page.php">+ Add New Article</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Detection Result</th>
            ...
            <?php include "../user_backend/user_article_search_modal.php"; ?>
        </div>
    </div>
