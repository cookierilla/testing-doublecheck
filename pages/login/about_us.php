...
<body>
    <!-- navbar -->
    <?php include "../../pages/include_elements/no_acc_navbar.php"; ?>
    ...
    <div id="main-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8 text-center">
                            ...
                            <p class="hero-text mb-5 poppins-medium">
                            ...
                            <a class="btn btn-lg buttonBrand" href="../registration/register.php"> Sign Up Now!</a>
                        ...
                        <div class="row justify-content-center align-items-stretch">
                            ...
                            <div class="col-lg-4 mb-4">
                                <div class="team-description-box">
                                    ...
                                    <a class="btn team-articles-button btnNav" >Double-Check Articles Now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <?php include "login_req_modal.php"; ?>
    </div>
    ...
    <script src="../../scripts/no_acc_script.js"></script>
</body>
